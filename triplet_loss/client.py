...
class ADClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        history = self.model.fit(
            ...
            epochs=epochs,
            validation_data=((X_val, X_pos[num_examples_train:], X_neg[num_examples_train:]), X_val)
        )
    ...
    def evaluate(self, parameters, config):
        ...
        loss = self.model.evaluate((X_test_ben_, X_pos, X_neg), X_test_ben_, 64, steps=None)
